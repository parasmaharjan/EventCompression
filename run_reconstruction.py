...
if __name__ == "__main__":
    ...
    parser.set_defaults(path_to_model='pretrained/E2VID_lightweight.pth.tar')
    
    parser.add_argument('-i', '--input_file', type=str)
    parser.set_defaults(input_file="data/dynamic_6dof.zip")
    ...
    parser.add_argument('--num_events_per_pixel', default=0.350, type=float,
        ...
        for event_window in event_window_iterator:
            ...
            with Timer('Building event tensor'):
                if args.compute_voxel_grid_on_cpu:
                    ...
                    # plt.subplot(1,5,1);plt.imshow(event_tensor[0,:,:], cmap="gray")
                    # plt.subplot(1,5,2);plt.imshow(event_tensor[1,:,:], cmap="gray")
                    # plt.subplot(1,5,3);plt.imshow(event_tensor[2,:,:], cmap="gray")
                    # plt.subplot(1,5,4);plt.imshow(event_tensor[3,:,:], cmap="gray")
                    # plt.subplot(1,5,5);plt.imshow(event_tensor[4,:,:], cmap="gray")
                    # plt.show()
